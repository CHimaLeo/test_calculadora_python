...
class TestUtil(unittest.TestCase):
    ...
    #Función InvalidConvertToNumber    
    ...
    #Función validate_permissions     
    def test_validate_permissions_correct_param(self):
        self.assertEqual(True, util.validate_permissions("4 + 4", "user1"))
        self.assertEqual(True, util.validate_permissions("4 - 4", "user1"))
        self.assertEqual(True, util.validate_permissions("4 * 4", "user1"))
        self.assertEqual(True, util.validate_permissions("4 / 4", "user1"))
        self.assertEqual(True, util.validate_permissions("4 ** 4", "user1"))
        self.assertEqual(True, util.validate_permissions("4", "user1"))
        self.assertEqual(True, util.validate_permissions("4", "user1"))
        
    def test_validate_permissions_invalid_type(self):
        self.assertEqual(False, util.validate_permissions("4 + 4", "user2"))
        self.assertEqual(False, util.validate_permissions("4 - 4", "user2"))
        self.assertEqual(False, util.validate_permissions("4 * 4", "user2"))
        self.assertEqual(False, util.validate_permissions("4 / 4", "user2"))
        self.assertEqual(False, util.validate_permissions("4 ** 4", "user2"))
        self.assertEqual(False, util.validate_permissions("4", "user2"))
        self.assertEqual(False, util.validate_permissions("4", "user2"))
